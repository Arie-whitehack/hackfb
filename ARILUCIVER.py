...
def user_dev():
  try:
  	print multi_ban
  	us = raw_input("\033[96;1m {\033[97;1m@\033[96;1m}\033[92;1m Masukkan Nama Target, Conth:\033[96;1m lucinta\n\033[97;1m  ==> ")
  	...
  	if us == '' or us == ' ' or san_dev == '' or san_dev == ' ':
  		exit('\n \033[91;1m nya Ulah Kosong Goblog.. \n')
  	print '\n\033[95;1m<<\033[96;1m sabar Sayang Tunggu Aja,kayak Mantan!\033[95;1m >> \n'
